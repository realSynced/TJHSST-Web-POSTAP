...
def update_visited_places(location):
    user_state = create_or_retrieve()
    print("User state", user_state)
    if location not in user_state["visited_places"]:
        user_state["visited_places"].append(location)
...
def set_hero(hero):
    ...
    return render_template("hero.html", user_data=user_state)
...
def place_page(location):
    ...
    update_visited_places(location)
